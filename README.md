...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/hcloud-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=15231&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/hcloud-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `hcloud` can be installed with:

```
conda install hcloud
```

It is possible to list all of the versions of `hcloud` available on your platform with:
